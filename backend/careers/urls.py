...
from .views import (CareerListView, AnalyzeInterestsView, SavedCareersView,
                    GenerateRoadmapView, GenerateRoadmapByTitleView, UserAnalysisHistoryView,
                    GenerateStudyPlanView, StudyPlanDetailView, MatchCareersFromQuizView)
...
urlpatterns = [
    ...
    path('roadmap/generate-by-title/', GenerateRoadmapByTitleView.as_view(), name='generate-roadmap-by-title'),
